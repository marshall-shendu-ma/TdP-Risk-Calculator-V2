document.addEventListener('DOMContentLoaded', function() {
  ...
  // --- Collapsible sections (null-safe) ---
  ...
  function calculate(predOnly) {
    ...
    if (predOnly) {
      ...
      const hillCtx = document.getElementById('hillPlot');
      if (hillCtx) {
        hillChart = new Chart(hillCtx, {
          type:'line',
          data:{ datasets:[
