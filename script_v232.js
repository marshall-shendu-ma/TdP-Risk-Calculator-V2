...
function updateModelPanel(){
    ...
    modelChart=new Chart(document.getElementById('modelChart'), {
      ...
      options:{ scales:{ x:{ grid:{lineWidth:5}, ticks:{font:{size:20}} }, y:{ beginAtZero:true, max:100, grid:{lineWidth:5}, ticks:{font:{size:20}}, title:{display:true, text:'Predicted Risk Probability', font:{size:18}} } }, plugins:{ legend:{display:false}, annotation:{ annotations:{ riskThreshold:{ type:'line', yMin:80, yMax:80, borderColor:'red', borderWidth:5, borderDash:[6,6], label:{ display:true, content:'Risk Probability Threshold', position:'end', color:'red', font:{size:16, weight:'bold'}, yAdjust:-8 } } } } } });
});